...
class PetFriends:
    ...
    def add_new_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод позволяет добавить фотографию питомца и возвращает статус
    ...
    def add_info_pet_without_photo(self, auth_key: json, name: str,
                        animal_type: str, age: int) -> json:
        """Метод позволяет добавить нового питомца и возвращает статус запроса и результат в формате JSON"""
